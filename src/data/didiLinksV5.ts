...
export const featuredVideo: FeaturedVideo = {
  ...
  description: {
    ko: 'Didi의 한국어와 한국 문화를 영상으로 만나보세요.',
    en: 'Watch Didi’s Korean language and culture content.',
    ja: 'Didiの韓国語と韓国文化の動画を見てみましょう。',
  },
  embedUrl: 'https://www.youtube.com/embed/-0onkcj3dHg',
  watchUrl: 'https://www.youtube.com/watch?v=-0onkcj3dHg',
}
